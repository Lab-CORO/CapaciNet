...
namespace sphere_discretization
{
    ...
    public:
        ...
        void make_sphere_poses(const octomap::point3d &origin, double r, std::vector< geometry_msgs::msg::Pose >& pose_Col);
        ...
        void convertPoseToVector(const geometry_msgs::msg::Pose &pose, std::vector< double >& data);

        //! Converting vector[7] to geometry_msgs::Pose
        void convertVectorToPose(const std::vector< double >& data, geometry_msgs::msg::Pose& pose);

        //! Finding optimal pose by averaging all and returning pose
        geometry_msgs::msg::Pose findOptimalPose(const std::vector< geometry_msgs::msg::Pose >& poses, const octomap::point3d& origin);

        //! Creates cone by PointCloud
        // void createConeCloud(const geometry_msgs::msg::Pose &pose, const double angle, const double scale,
        //                      pcl::PointCloud< pcl::PointXYZ >::Ptr cloud);

        //! Creates point by removing orientation part of a pose
        void poseToPoint(const geometry_msgs::msg::Pose& pose, octomap::point3d& point);
        ...
        void poseToEigenVector(const geometry_msgs::msg::Pose& pose, Eigen::VectorXd& vec);

        //! Finds optimal pose of given poses by Principal Component Optimization
        void findOptimalPosebyPCA(const std::vector< geometry_msgs::msg::Pose >& probBasePoses, geometry_msgs::msg::Pose& final_base_pose);
        ...
        void findOptimalPosebyAverage(const std::vector< geometry_msgs::msg::Pose > probBasePoses,
